<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./application/admin/view2/index/welcome.html";i:1510797706;}*/ ?>
<html>
<head>
                ...
                <div class="section section_order_count">
                    ...
                    <div class="sc_warp" style="padding-bottom: 30px;">
                        <table cellpadding="0" cellspacing="0" class="system_table">
                            ...
                            <tr>
                                <td class="gray_bg">开发环境:</td>
                                <td>Windows+Apache+Mysql+Php</td>
                                <td class="gray_bg">项目类型:</td>
                                <td>单用户商城</td>
                            </tr>
                            <tr>
...
<div id="footer" style="position: static; bottom: 0px; font-size:14px;">
    <p><b>版权所有 © 2017-2029 大庆市顺亿科技有限公司，并保留所有权利。</b></p>
</div>
