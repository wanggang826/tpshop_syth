<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view2/user/index.html";i:1512381832;s:44:"./application/admin/view2/public/layout.html";i:1508133828;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="user_id" axis="col3" class="">
                            <div style="text-align: center; width: 40px;" class="">编号</div>
                        </th>
                       ...
                       <!-- <th align="center" abbr="level" axis="col5" class="">
                        ...
                        <th align="center" axis="col6" class="" >
                            <div style="text-align: center; width: 80px;" class="">会员级别</div>
                        </th>
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 80px;" class="">会员职称</div>
                        </th>
                       ...
                       <th align="center" abbr="user_money" axis="col6" class="">
                            <div style="text-align: center; width: 60px;" class="">资金</div>
                        </th>
                        <th align="center" abbr="pay_points" axis="col6" class="">
                            <div style="text-align: center; width: 60px;" class="">账户积分</div>
                        </th>
                        <th align="center" abbr="xinyongjin" axis="col6" class="">
                            <div style="text-align: center; width: 60px;" class="">信用金</div>
                        </th>
                        <th align="center" abbr="pay_xinyongjin" axis="col6" class="">
                            <div style="text-align: center; width: 60px;" class="">月余信用金</div>
                        </th>
                        <th align="center" abbr="laver_num" axis="col6" class="">
                            <div style="text-align: center; width: 50px;" class="">下级管理</div>
                        </th>
                        <th align="center" abbr="laver_money" axis="col6" class="">
                            <div style="text-align: center; width: 60px;" class="">总交易额</div>
                        </th>
