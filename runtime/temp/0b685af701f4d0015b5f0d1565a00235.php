<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./application/admin/view2/ad/adList.html";i:1510134680;s:44:"./application/admin/view2/public/layout.html";i:1508133828;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="flexigrid">
    ...
    <div class="hDiv">
      <div class="hDivBox">
        <table cellspacing="0" cellpadding="0">
          <thead>
            <tr>
              <th class="sign" axis="col3">
                <div style="width: 100px;"><i class="ico-check"></i></div>
              </th>
              <th align="left" abbr="article_title" axis="col3" class="">
                <div style="text-align: left; width: 100px;" class="">推荐商品id</div>
              </th>
              <th align="left" abbr="ac_id" axis="col4" class="">
                <div style="text-align: left; width: 200px;" class="">摆放位置</div>
              </th>
              <th align="center" abbr="article_time" axis="col6" class="">
                <div style="text-align: center; width: 150px;" class="">图片</div>
              </th>
              <th align="center" abbr="article_time" axis="col6" class="">
    ...
    <div class="tDiv">
      <div class="tDiv2">
        <div class="fbutton"><a href="<?php echo U('Ad/ad'); ?>"><div class="add" title="新增广告"><span><i class="fa fa-plus"></i>新增推荐</span></div></a></div>
            ...
            <?php if(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty())): ?>
              ...
              <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                <tr>
                  ...
                  <td align="left" class="">
                    <div style="text-align: left; width: 100px;"><?php echo $vo[ad_id]; ?></div>
                  </td>
                  <td align="left" class="">
                    <div style="text-align: left; width: 200px;"><?php echo $ad_position_list[$vo[pid]][position_name]; ?></div>
                  </td>
                  <td align="center" class="">
                    <div style="text-align: center; width: 150px;"><img src="<?php echo $vo['ad_code']; ?>" width="80px" height="45px"></div>
                  </td>
