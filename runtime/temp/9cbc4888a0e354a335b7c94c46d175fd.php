<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view2/index/index.html";i:1516244648;s:42:"./application/admin/view2/public/left.html";i:1516244526;}*/ ?>
<!doctype html>
<html>
<head>
...
<!--      <li data-param="mobile"><a href="javascript:void(0);">模板</a></li>-->
  ...
  <div class="admincp-header-r">
    <div class="manager">
      ...
      <dl>
        <dt class="name"></dt>
        <dd class="group"><span style="font-size:22px;">顺亿商城管理中心</span></dd>
