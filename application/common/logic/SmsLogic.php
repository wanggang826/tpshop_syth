...
class SmsLogic 
{
    ...
    {
        /*验证码通过短信发送*/
        //进过多次测试完全没有问题,使用时请更换短信平台信息
//        $data = input();
//        $url        = "http://www.ztsms.cn/sendSms.do";//提交地址
//        $username   = 'liesunsmszh';//用户名
//        $password   = 'Liesun666';//原密码
//        vendor('Alidayu.sendAPI');
//        $sendAPI = new \sendAPI($url, $username, $password);
//        $array_code = json_decode($smsParam);//生成6位数验证码
//        $list['code']=$array_code->code;
//        $data = array(
//            'content'   =>'验证码:'.$list['code'].'.如非本人操作,请忽略!【顺亿商城】',//短信内容
//            'mobile'    => $mobile,//手机号码
