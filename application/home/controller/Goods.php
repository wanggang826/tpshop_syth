...
class Goods extends Base {
    ...
    */ 
    public function goodsInfo(){
       ...
       if(session('user.user_id')){//用户已经登录
           $user_id = session('user.user_id');
           $goods_url = "http://"."$_SERVER[HTTP_HOST]/index.php?m=Mobile&c=Goods&a=goodsInfo&id={$_GET[id]}&user_id = $user_id";
       }else{
           $goods_url = "http://"."$_SERVER[HTTP_HOST]/index.php?m=Mobile&c=Goods&a=goodsInfo&id={$_GET[id]}";
       }
        //------------生成二维码开始---------------//
        ...
        $this->assign('qrcode',$goodsQr);//商品二维码
        return $this->fetch();
    }
