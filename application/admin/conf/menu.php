...
return	array(	
	'system'=>array('name'=>'系统','child'=>array(
				...
				array('name' => '会员','child'=>array(
                      ...
                      /*  array('name'=>'会员职称','act'=>'jobTitle','op'=>'User'),*/
                        //array('name'=>'会员返点','act'=>'rebates','op'=>'User'),
				...
				array('name' => '推荐商品','child' => array(
						array('name'=>'推荐列表','act'=>'adList','op'=>'Ad'),
						array('name'=>'推荐位置','act'=>'positionList','op'=>'Ad'),
				)),
...
//			)),
	...
	'mobile'=>array('name'=>'模板','child'=>array(
			array('name' => '设置','child' => array(
					...
					array('name' => '推荐管理', 'act'=>'finance', 'op'=>'Report'),
					array('name' => '推荐位管理', 'act'=>'finance', 'op'=>'Report'),
			)),
	)),
		
	'resource'=>array('name'=>'插件','child'=>array(
        array('name' => '插件','child' => array(
