...
class Goods extends Base {
    ...
    public function addEditGoods()
    {
        ...
        if ((I('is_ajax') == 1) && IS_POST) {
            ...
            $return_url = $is_distribut > 0 ? U('admin/Distribut/addEdit') : U('admin/Goods/goodsList');
            $data = input('post.');
            if($data['percent']>0){
                $data['percent']= $data['percent']/100;
            }
            if($data['rebates']>0){
                $data['rebates']= $data['rebates']/100;
            }
        ...
        $goodsInfo['percent'] =$goodsInfo['percent']*100;
        $goodsInfo['rebates'] =$goodsInfo['rebates']*100;
